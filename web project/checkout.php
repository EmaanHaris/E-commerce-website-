    ...
    <body>
            ...
            <a href="homePage.html" class="nav__logo">
                ...
                <div class="nav__menu" id="nav_menu">
                    <ul class="unlist">
                        ...
                        <li class="item"><a href="#" class="nav__link active-link">Shop</a></li>
                   
                        <li class="item"><a href="#" class="nav__link">Cart</a></li>
                   
                        <li class="item"><a href="#" class="nav__link">Blog</a></li>
                   
                        <li class="item"><a href="#" class="nav__link">FAQs</a></li>
        ...
        <div class="cart " id="cart">
              ...
              <?php
                ...
                echo "<div class='cartCheckout'>
                    <button class='btn checkout' type='submit' name='update'>Update</button>
                </div>
                <div class='cartCheckout'>
                      <button class='btn checkout'><a href='checkout.php'>Check Out</a></button>
                </div>";
                 echo" </form>";
                  ...
                  ?>
                    ...
                    <!--article class="cartCard">
                        <div class="cartBox">
                            <img class="cartImg" alt="cart" src="images/red headphone.jfif">
                        </div>
                        <div class="cartDetails">
                            <h3 class="cartTitle">Headphone-Red</h3>
                            <span class="cartPrice">$18</span>
                            <div class="cartAmount">
                                <div class="cartAmount-content">
                                    <span class="cartAmount-box">
                                        <i class="bx bx-minus"></i>
                                    </span>
                                    <span class="cartAmount-num">1</span>
                                    <span class="cartAmount-box">
                               ...
                               <i class="bx bx-trash-alt cartAmount-trash"></i>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="cartCard">
                        <div class="cartBox">
                            <img class="cartImg" alt="cart" src="images/simple headphone.jpg">
                        </div>
                        <div class="cartDetails">
                            <h3 class="cartTitle">Simple Headphone</h3>
      ...
      <script>
        ...
        <div class="login" id="login">
                ...
                <form action="checkout.php" method="POST" class="loginForm grid">
                    <div class="loginContent">
                        <label for="login" class="loginLabel">Email</label>
                    ...
                    <div>
                        <p class="signUp">Not a member? <a href="customer_register.php">Sign Up</a></p>
                    </div>
                </form>
        </div>
        <!--?php
